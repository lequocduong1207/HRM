        ...
        <ComponentCard title="Chi tiết chấm công">
          ...
          <div className="mb-4 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
            ...
            <div className="flex gap-2 sm:ml-auto">
              <button className="flex-1 sm:flex-none rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800">
                Xuất Excel
              </button>
              <button className="flex-1 sm:flex-none rounded-lg bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-700">
                + Chấm công
              </button>
            </div>
          </div>
